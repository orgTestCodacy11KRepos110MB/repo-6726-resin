...
namespace Sir.HttpServer
{
    ...
    public class HttpQueryParser
    {
        ...
        public async Task<IQuery> ParseRequest(HttpRequest request, IEnumerable<string> collections = null, IEnumerable<string> fields = null, IEnumerable<string> select = null)
        {
            if (select == null)
